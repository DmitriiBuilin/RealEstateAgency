            ...
            <main className="main">
                ...
                <div className="search-result">                
                    {cardsListFilter.map((item) => {
                        return(
                            <CardItem key={item.id} id={item.id} objectName={item.objectName} price={item.price} description={item.description} rooms={item.rooms} m2gross={item.m2gross} city={item.city} data={item.data} img_1={item.img_1} img_2={item.img_2} img_3={item.img_3} img_4={item.img_4} img_5={item.img_5}/>
                        )                    
                    })}
                </div>            
            </main>
